...
<ComponentPreview>
  <div className="flex flex-col gap-4">
    ...
    <Label variant="compact">Compact label</Label>
  </div>
</ComponentPreview>
...
<ComponentPreview>
  <div className="flex flex-col gap-1.5">
    <Label htmlFor="compact-email" variant="compact">Email address</Label>
    <Input id="compact-email" type="email" placeholder="you@example.com" className="w-64" />
  </div>
</ComponentPreview>

```tsx
<Label htmlFor="email" variant="compact">Email address</Label>
<Input id="email" type="email" placeholder="you@example.com" />
```
...
|------|------|---------|-------------|
| `variant` | `"default" \| "compact"` | `"default"` | `default` is 14.22px, `compact` is 12.44px. |
